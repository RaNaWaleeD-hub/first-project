    ...
    <>
      <div className="topbar">
        ...
        <Breadcrumb className="breadCrumb">
          <Breadcrumb.Item active>Wordpress</Breadcrumb.Item>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
        </Breadcrumb>
        <p className="para1">Learn Wordpress</p>
      </div>
      <Container>
        <Row>
          <Col>
            <img
              ...
              src="https://tse3.mm.bing.net/th?id=OIP.YEeDOQGiywpKBxKW4MGmkQHaEK&pid=Api&P=0"
              alt="sadaa"
            />
          </Col>
          <Col>
            <h1 className="Wtext">Wordpress</h1>
            <p className="p1text">Getting started with wordpress</p>
