    ...
    <>
      <div className="topbar">
        ...
        <Breadcrumb className="breadCrumb">
          <Breadcrumb.Item active>Front-End Development</Breadcrumb.Item>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
        </Breadcrumb>
        <p className="para1">Learn Front-End Development</p>
      </div>
      <Container>
        <Row>
          <Col>
            <img
              ...
              src="https://tse1.mm.bing.net/th?id=OIP.qAp404m16RcIXjO7ieqLUgHaEK&pid=Api&P=0"
              alt="sadaa"
            />
          </Col>
          <Col>
            <h1 className="Wtext">Front-end Development</h1>
            <p className="p1text"> Start with Front-end Dev</p>
