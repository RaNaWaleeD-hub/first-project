...
import Logoimg from "../../../assets/svg/heyteclogo.png";
    ...
    <>
      <div className="topbar">
        ...
        <Breadcrumb className="breadCrumb">
          <Breadcrumb.Item active>Andoid & IOS App Development</Breadcrumb.Item>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
        </Breadcrumb>
        {/* <p className="para1">Andoid & IOS App Development</p> */}
        <a href="/">
          <img
            className="heytecLogo"
            src={Logoimg}
            alt="heytec logo"
            style={{ height: "4rem" }}
          />
        ...
        <Row>
          <Col>
            <img
              ...
              src="https://tse3.mm.bing.net/th?id=OIP.G4TyEcBprzWWUgyHVA8wFQHaDw&pid=Api&P=0"
              alt="sadaa"
            />
          </Col>
          <Col>
            <h1 className="Wtext"> App Development</h1>
            <p className="p1text">Getting start Andoid & IOS App Development</p>
