    ...
    <>
      <div className="topbar">
        ...
        <Breadcrumb className="breadCrumb">
          <Breadcrumb.Item active>SEO & Digital Marketing</Breadcrumb.Item>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
        </Breadcrumb>
        <p className="para1">Learn SEO & Digital Marketing</p>
      </div>
      <Container>
        <Row>
          <Col>
            <img
              ...
              src="https://tse4.mm.bing.net/th?id=OIP.1GmX99gOMsiA4lJxWNiPNgHaDn&pid=Api&P=0"
              alt="sadaa"
            />
          </Col>
          <Col>
            <h1 className="Wtext">SEO & Digital Marketing</h1>
            <p className="p1text">
              Getting started with SEO & Digital Marketing
            </p>
