    ...
    <>
      <div className="topbar">
        ...
        <Breadcrumb className="breadCrumb">
          <Breadcrumb.Item active>FreeLancing</Breadcrumb.Item>
          <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
        </Breadcrumb>
        <p className="para1">Learn FreeLancing</p>
      </div>
      <Container>
        <Row>
          <Col>
            <img
              ...
              src="https://tse2.mm.bing.net/th?id=OIP.VJL7ptzmb3KLJTV3rfLGYgHaEK&pid=Api&P=0"
              alt="sadaa"
            />
          </Col>
          <Col>
            <h1 className="Wtext">FreeLancing </h1>
            <p className="p1text">Getting started with FreeLancing </p>
